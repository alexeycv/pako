...
namespace Core.Conference
{
    ...
    public class MUser
    {
      ...
      /// <param name="args"></param>
        ...
        public MUser(string UserNick, Jid UserJid, Role UserRole, Affiliation UserAffiliation, string UserStatus, ShowType UserShow, string Lang, string EnterTime, int access)
        {
...
/*
        ...
        public int Access
        {
            ...
            set { lock (sobjs[7]) { m_access = value; } }
        }
