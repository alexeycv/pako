                ...
                case "disco":
                    {
                        if (ws.Length > 2)
                        {
                            DiscoCB dcb = new DiscoCB(m_r, new Jid(ws[2]));
                            return;
                        }
                        else
                            syntax_error = true;
                ...
                case "mylang":
                    {
                        ...
                        if (ws.Length > 2)
                        {
                            ...
                            {
                                if (Sh.S.AMManager.SetLanguage(m_r.MUC.Jid, lang))
                                {
                ...
                case "mystatus":
                    {
                        ...
                        if (ws.Length > 2)
                        {
                            ...
                            if (Sh.S.AMManager.SetStatus(m_r.MUC.Jid, status))
                            {
                ...
                case "mynick":
                    {
                        if (ws.Length > 2)
                        {
                            ...
                            if (Sh.S.AMManager.SetNick(m_r.MUC.Jid, nick))
                            {
                ...
                case "join":
                    {
                        ...
                        if (ws.Length == 3)
                        {
                            if (!Sh.S.AMManager.Exists(new Jid(ws[2].Trim())))
                            {
                                Sh.S.AMManager.AddMuc(new Jid(ws[2].Trim()), Sh.S.Config.Nick, Sh.S.Config.Status, Sh.S.Config.Language);
                            ...
                            if (ws.Length == 4)
                            {
                                if (!Sh.S.AMManager.Exists(new Jid(ws[2].Trim())))
                                {
                                    Sh.S.AMManager.AddMuc(new Jid(ws[2].Trim()), ws[3].Trim(), Sh.S.Config.Status, Sh.S.Config.Language);
                ...
                case "info":
                    {
                        ...
                        if (m_user != null)
                        {
                            UserData ud = Sh.S.UDManager.GetUserData(m_user.Jid);
