                ...
                case "join":
                    {
                        ...
                        if (ws.Length == 3)
                        {
                            ...
                            {
                                Sh.S.AutoMucManager.AddMuc(new Jid(ws[2].Trim()), Sh.S.Config.Nick, Sh.S.Config.Status, Sh.S.Config.Language);
                            ...
                            if (ws.Length == 4)
                            {
                                if (!Sh.S.AutoMucManager.Exists(new Jid(ws[2].Trim())))
                                {
                                    Sh.S.AutoMucManager.AddMuc(new Jid(ws[2].Trim()), ws[3].Trim(), Sh.S.Config.Status, Sh.S.Config.Language);
