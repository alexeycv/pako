    ...
    public class MiscHandler
    {
        ...
        public void Handle()
        {
            ...
            switch (cmd)
            {
                ...
                case "join":
                    {
                        ...
                        if (ws.Length == 3)
                        {
                            ...
                            {
                                MUC m = new MUC(Sh.S.C, new Jid(ws[2].Trim()), Sh.S.Config.Nick, Sh.S.Config.Status, Sh.S.Config.Language, ShowType.NONE, Sh.S.Censor.SQLiteConnection, _cmd.Trim() != "" ? _cmd : null);
                            ...
                            if (ws.Length == 4)
                            {
                                if (!Sh.S.AutoMucManager.Exists(new Jid(ws[2].Trim())))
                                {
                                    MUC m = new MUC(Sh.S.C, new Jid(ws[2].Trim()), ws[3].Trim(), Sh.S.Config.Status, Sh.S.Config.Language, ShowType.NONE, Sh.S.Censor.SQLiteConnection,_cmd.Trim() != "" ? _cmd : null);
                                    Sh.S.MUCs.Add(new Jid(ws[2].Trim()), m);
                                    MucActivityController mac = new MucActivityController(m_r, m);
                                    return;
                ...
                case "list":
                    {
                        rs = m_r.f("volume_list", n) + "\nlist, access, calc, cs, make, say, test, langs, join, leave, cmds";
                        break;
                    }
