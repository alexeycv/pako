...
namespace Plugin
{
    public class Evaluator
    {
        ...
        public string Compile(string expression, SessionHandler Sh, Response r)
        {
            ...
            cpar.ReferencedAssemblies.Add(db.b(Utils.CD, "Mono.Data.SqliteClient.dll"));
            ...
            string source = @"
                    ...
                    {
                        public string eval(SessionHandler sh, Response r)
                        {
                             " + expression + @"
                        }
                    }   
            ...
            try
            {
                ...
                if (cr.CompiledAssembly != null)
                {
                    ...
                    if (ObjType != null)
                    {
                        ...
                        _result = (string)_method.Invoke(Activator.CreateInstance(ObjType), new object[] { Sh, r });
                    }
                    else
                        _result = null;
