                ...
                case "kick":
                    {
                        if (ws.Length > 2)
                        {
                           ...
                           if (reason == null)
                            ...
                            ws = Utils.SplitEx(m_b, 2);
                            if (m_r.MUC.UserExists(ws[2].Trim()))
                            {
                                if (m_r.MUC.KickableForCensored(m_r.MUC.GetUser(ws[2])))
                                {
                                    m_r.Reply(m_r.Deny());
                                    return;
                                }
                                ...
                                if (ws[2].Trim() == "clear")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        foreach (MUser user in m_r.MUC.Users.Values)
                                        {
                                            ...
                                            if (ak != null)
											    if (m_r.MUC.KickableForCensored(user))
                                                m_r.MUC.Devoice(user.Nick, Utils.FormatEnvironmentVariables(ak, m_r.MUC, user));
                                        }
                                ...
                                if (ws[2] == "clear")
                                {
                                    ...
                                    if (ws[2] == "show")
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                rs = Sh.S.GetMUC(m_r.MUC.Jid).VipAccess.GetAccess(new Jid(ws[3])).ToString();
                                                if (rs == "-1")
                                                    rs = m_r.f("vip_not_found", ws[3]);
                                            }
                                        }
                            ...
                            if (ws[2] == "del")
                            {
                                ...
                                if (ws[2] == "show")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (!Sh.S.JidValid(Jid))
                                        {
                                            m_r.f("jid_not_valid", Jid.ToString());
                                            return;
                                        }
                                        ...
                                        if (Sh.S.Tempdb.AddAutoModerator(Jid, m_r.MUC.Jid, period))
                                        {
                                            ...
                                            foreach (MUser _user in m_r.MUC.Users.Values)
                                            {
                                                if (Sh.S.Tempdb.AutoModerator(_user.Jid, m_r.MUC.Jid))
                                                    m_r.MUC.Changer(agsXMPP.protocol.x.muc.Role.moderator, m_r.MUC.Jid, null, _user.Nick, null, null, null);
                                            }
                                        }
                                        else
                ...
                case "jid":
                    {
                        ...
                        if (m_user != null)
                        {
                            ...
                            if (m_user.Access != 100)
                                rs = m_r.f("real_jid", m_user.Nick, m_user.Jid.ToString());
                            else
                                rs = m_r.f("real_jid_hidden_my_admin");
                        }
                        break;
                    }
                ...
                case "list":
                    {
                        if (ws.Length == 2)
                        {
                            rs = m_r.f("volume_list", n) + "\nlist, censor, tell, role, owner, admin, moderator, member, voice, devoice, none, akick, kick, ban, tryme, status, disco, nicks, show, entered, info, me, mylang, mynick, mystatus, name, subject, setsubject, greet, cmdaccess, echo, jid, clean, amoderator, avisitor";
                        }
                        break;
                    }
