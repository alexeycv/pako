...
namespace Core.Other
{
    ...
    static public class Utils
    {
        ...
        static public string FormatEnvironmentVariables(string Source, MUC muc, MUser user)
        {
            ...
            string res = Source
                         .Replace(strs[0], user)
                         .Replace(strs[1], muc.Connection.Server)
                         .Replace(strs[2], muc.Jid.ToString())
                         .Replace(strs[3], user.Jid.Bare)
                         .Replace(strs[4], user.Status)
                         .Replace(strs[5], user.Language)
                         .Replace(strs[6], user.Access.ToString())
                         ...
                         .Replace(strs[16], muc.MyNick)
                         .Replace(strs[17], Bot["os"])
                         .Replace(strs[18], Bot["version"]);
            if (muc.Subject != null)
                res = res.Replace(strs[19], muc.Subject);
