...
namespace Core.Kernel
{
    public class Cmd
    {
        ...
        /// <param name="c"></param>
        /// <returns></returns>
        static public implicit operator string(Cmd c)
        {
            return c.Body;
        }
        ...
        Cmd(string cmd, Response r, bool? roster)
        {
            ...
            if (r.MUC != null && r.MUser != null && (roster == null || (roster != null && roster == false)))
            {
                ...
                if (r.MUC.chkal_rec(m_body, 0, r.Sh.S.Config.RecursionLevel, r.MUser))
                {
                ...
                while (r.MUC.HasAlias(m_body))
                {
                    ...
                    m_body = r.MUC.GetAlias(m_body, ref al_name, ref al_body, ref al_temp_f, r.MUser);
                    if (steps == 0)
