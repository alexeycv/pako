    ...
    public class Cmd
    {
        ...
        Cmd(string cmd, Response r, bool? roster)
        {
            ...
            if (r.MUC != null && r.MUser != null && (roster == null || (roster != null && roster == false)))
            {
                ...
                naccess = r.MUC.OptionsHandler.GetOption("cmdaccess") == "+" ? r.MUC.AccessManager.GetAccess(m_body) : null;
                ...
                if (alias_exists)
                {
                    ...
                    int? _naccess = 0;
                    r.Format = false;
                    _nalias = r.MUC.OptionsHandler.GetOption("cmdaccess") == "+" ? r.MUC.AccessManager.GetAccess(al_body) : null;
                    _naccess = r.MUC.OptionsHandler.GetOption("cmdaccess") == "+" ? r.MUC.AccessManager.GetAccess(m_body) : null;
                    if (_nalias == null)
                        _nalias = r.Sh.S.AccessManager.GetAccess(al_body);
                    if (_naccess == null)
                        _naccess = r.Sh.S.AccessManager.GetAccess(m_body);
            ...
            volume = args[0];
                ...
                if (naccess == null)
                {
                    ...
                    this.acc_type = AccessType.SetByAdmin;
                    naccess = r.Sh.S.AccessManager.GetAccess(m_body);
                }
