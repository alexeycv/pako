...
namespace Core.Kernel
{
    ...
    public class CommandHandler
    {
        ...
        public CommandHandler(agsXMPP.protocol.client.Message msg, SessionHandler s, Jid emulation)
        {
            m_msg = msg;
            ...
            if ((m_type == msgType.MUC) || (m_type == msgType.Roster))
            {
                ...
                if (is_muser)
                {
                    ...
                    if (found_censored != null)
                    {
                        ...
                        {
                            m_muc.Kick(m_user.Nick, Utils.FormatEnvironmentVariables(found_censored, m_muc, m_user));
                            return;
                        }
                        else
                        {
