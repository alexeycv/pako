...
namespace Core.Xml
{
	public class OptionsHandler : XMLContainer
	{
		...
		public OptionsHandler(string file)
        {
           ...
           string[] opts = new string[] { "global_censor", "censor_result", "vcensor_result", "rcensor_result", "amoderator", "akick", "avisitor", "aliases", "mode", "cmdaccess", "cleanup_unit", "enable_logging", "nick_limit", "nick_limit_result", "length_limit", "length_limit_overflow_result" };
