...
/// </summary>
    ...
    static public class Utils
    {
       ...
       /// <returns></returns>
        static public string GetValue(this string Source, string Pattern, params object[] args)
        {
       ...
       /// <param name="args"></param>
       /// <returns></returns>
        static public string RemoveValue(this string Source, string Pattern, params object[] args)
        {
       ...
       /// <param name="To"></param>
       /// <returns></returns>
        static public string ReplaceOnce(this string Source, string From, string To)
        {
       ...
       /// <returns></returns>
        static public string[] SplitEx(this string Source, int Fixed)
        {
        ...
        /// <summary>
        /// A formatter for a TimeSpan, you need a ticks count.
        /// </summary>
        /// <param name="Ticks"></param>
        /// <param name="r"></param>
        /// <returns></returns>
        static public string FormatTimeSpan(this long Ticks, Response r)
        {
