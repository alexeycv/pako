                ...
                case "list":
                    {
                        if (ws.Length == 2)
                        {
                            rs = m_r.f("volume_list", n) + "\nlist, allcensor, censor, uncensor, tell, role, owner, admin, moderator, member, voice, devoice, none, akick, kick, ban, tryme, status, disco, nicks, show, entered, info, join, leave, me, mylang, mynick, mystatus, name, subject, setsubject, cmdaccess, echo, jid, clean";
                        }
                        break;
                    }
