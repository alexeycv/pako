                ...
                case "version":
                    {
                        ...
                        if (ws.Length > 2)
                        {
                            ...
                            if (Sh.S.C.MyJID.ToString() == arg)
                                {
                                    m_r.Reply(m_r.FormatPattern("version_me") + " " + "Pako bot " + Sh.S.MyVersion + " (C# 2.0 .NET/Mono) on base: " + Sh.S.OSVersion);
                                    return;
                                }
                ...
                case "info":
                    {
                        ...
                        if (ws.Length > 2)
                        {
                            ...
                            if (Sh.S.C.MyJID.ToString() == arg)
                            {
                                m_r.Reply(m_r.FormatPattern("disco_info_me"));
                                return;
                            }
                ...
                case "list":
                    {
                        if (ws.Length == 2)
                        {
                            rs = m_r.FormatPattern("volume_list", n) + "\nlist, time, version, ping, disco, info, uptime";
                        }
                        break;
                    }
